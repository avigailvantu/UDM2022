...
We have filtered the 311 data to only include the Manhattan complaints. Therefore, we will not need the other 4 boroughs on the NTA layer.
...
Tip: this is a good time to take a coffee break :) the analysis may take a little bit of time (~ a few seconds to 30-40 min depending on your computer and QGIS version). Be patient and make sure your computer is connected to the electricity before executing the analysis.


#### 5. Visualize the data

Once we have the 311 noise point in polygon analysis completed we can start making sense of the data.
...
- Export two-three maps (no more than 3 please):
